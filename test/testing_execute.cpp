...
//
//TEST_F(ExecuteTest, StressTBBHashmap) {
//    int n_workers = 10;
...
//    }
//    sync::CountDownLatch latch(n_workers);
//
...
//    };
//
//    TimedThroughputReporter reporter(n);
...
//}
//
//TEST_F(ExecuteTest, StressCuckooHashmap) {
//    int n_workers = 10;
//    CuckooMap<uint32_t, uint32_t> m;
//    int n = 131702 * 3;
//    for (int i = 0; i < n; ++i) {
//        m.Insert(i, i);
//    }
